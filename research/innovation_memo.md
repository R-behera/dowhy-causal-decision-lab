# Innovation memo: DoWhy Causal Decision Lab

        ## Research anchor

        - Paper: DoWhy: An End-to-End Library for Causal Inference
        - Score: 9.775/10
        - Official repo: https://github.com/py-why/dowhy

        ## What this project does differently

        - Translate upstream causal product analytics logic into stakeholder-ready dashboards, memos, and scenario controls.
